...
'''"This behavior will let the Nao sit down in order to defend the goal, until te ball is no longer seen"'''

class Defend(basebehavior.abstractbehavior.AbstractBehavior):
    ...
    def check_postcondition(self):
        m = memory.Memory()
        return eval("m.is_now('goal_defended',['True'])")

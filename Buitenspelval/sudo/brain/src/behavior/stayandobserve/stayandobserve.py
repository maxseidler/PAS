...
'''"This behavior will move the Nao in front of the own goal, until the ball is seen"'''

class StayAndObserve(basebehavior.abstractbehavior.AbstractBehavior):
    ...
    def get_name(self):
        return "StayAndObserve"

    def check_postcondition(self):
        m = memory.Memory()
        return eval("m.is_now('ball_seen',['True'])")

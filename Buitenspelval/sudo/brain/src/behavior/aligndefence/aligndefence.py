...
'''"This behavior will align the Nao between the ball and the own goal"'''

class AlignDefence(basebehavior.abstractbehavior.AbstractBehavior):
    ...
    def check_postcondition(self):
        m = memory.Memory()
        return eval("m.is_now('ball_aligned',['True'])")

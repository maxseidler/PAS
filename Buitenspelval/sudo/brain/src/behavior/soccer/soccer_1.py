...
class Soccer_x(basebehavior.behaviorimplementation.BehaviorImplementation):
    ...
    def implementation_init(self):
        ...
        self.exampleblobdetector = self.ab.exampleblobdetector({})
        self.findball = self.ab.findball({'ball_color':self.ball_color})
        self.approachball = self.ab.approachball({'ball_color':self.ball_color})
        self.aligngoal = self.ab.aligngoal({'ball_color':self.ball_color, 'target_goal': self.target_goal})
        ...
        #self.nao.say("Nothing like Buitenspelval!")
